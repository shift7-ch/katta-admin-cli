...
public class MinIOSTSStorage implements Callable<Void> {
    ...
    public Void call() throws Exception {
        ...
        System.out.printf("""
                        ...
                        # Note: "mc idp openid add <name> ... role_policy=..." is an equivalent shorthand of current
                        # mc versions, writing the same "identity_openid:<name>" configuration as shown here.
